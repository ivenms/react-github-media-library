...
export const SearchAndFilter: React.FC<SearchAndFilterProps> = ({
  ...
  return (
    <div className="rgml-flex rgml-flex-col sm:rgml-flex-row rgml-gap-4 rgml-mb-8">
      ...
      {categories.length > 1 && (
        <div className="rgml-relative rgml-min-w-[160px]">
          ...
          <select
            ...
            className={`rgml-appearance-none rgml-w-full rgml-pl-10 rgml-pr-8 rgml-py-3 rgml-rounded-xl rgml-border-2 rgml-transition-all rgml-duration-200 focus:rgml-outline-none focus:rgml-ring-2 focus:rgml-ring-blue-500/20 ${
              isDark 
          ...
          <ChevronDown className={`rgml-absolute rgml-right-3 rgml-top-1/2 rgml-transform -rgml-translate-y-1/2 rgml-w-5 rgml-h-5 rgml-pointer-events-none ${
            isDark ? 'rgml-text-gray-400' : 'rgml-text-gray-500'
          }`} />
        </div>
      )}
